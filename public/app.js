...
const I18N = {
  ...
  es: {
    ...
    lobbyMatchesLabel: 'Partidas activas',
    matchesCount: '({n})',
    nextMatch: 'Siguiente ▶',
    send: 'Enviar',
    roomChatLabel: 'Chat de sala',
    quickNotePlaceholder: 'Nota rápida para la mesa…',
    stockLabel: 'Mazo',
    discardLabel: 'Descarte',
    drawStockLabel: 'Robar del mazo',
    drawDiscardLabel: 'Robar del descarte',
    yourHandLabel: 'Tu mano',
    deadwoodLabel: 'sobrante',
    yourTurnDraw: 'Tu turno — Roba',
    yourTurnDiscard: 'Tu turno — Descarta',
